...
$query                   = $_GET['q'];
$res                     = search($query);
$_SESSION['titles']      = $res[1];
$_SESSION['contents']    = $res[2];
$_SESSION['identifiers'] = $res[0];
}
?>
            ...
            <?php if (isset($_GET["q"])) {
                ...
                if (isset($_SESSION["titles"])) {
                    for ($i = 0; $i < count($_SESSION["titles"]); $i++) { ?>
                        <h3><a href="page?q=<?php echo $_SESSION["identifiers"][$i]; ?>"><?php echo $_SESSION["titles"][$i]; ?></a></h3>
                    <?php } ?>
                    <?php
                }
                ?>
                ...
                echo "<h3><br />Keine Suchanfrage</h3>";
            } ?>
        </div>
    </div>
</div>
